...
/// The real Inference Gateway. Also used directly by compass.rs and
/// spaces.rs — a server-to-server call has no Atlas session to attach, so it
/// can't go through this route's own AuthUser-gated proxy below without
/// 401ing against itself.
