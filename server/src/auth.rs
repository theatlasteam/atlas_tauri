...
pub const USER_COLUMNS: &str =
    "id, handle, name, bio, status, avatar_color, avatar_initial, avatar_attachment_id, last_seen_at, verified, read_receipts, last_seen_visible, is_bot, COALESCE(atlas_x, false) AS atlas_x";
