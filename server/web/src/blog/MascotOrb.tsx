...
export default function MascotOrb(props: { state: MascotState; size?: number }) {
  ...
  return (
    <div>
      ...
      >
        <defs>
          <linearGradient id="mx-grad" x1="231" y1="0" x2="231" y2="357" gradientUnits="userSpaceOnUse">
            <stop stop-color="#e8933c" />
            <stop offset="1" stop-color="#8a4d16" />
          </linearGradient>
        </defs>
        <g
          class="mx-body"
        ...
        >
          ...
          >
            ...
            <Show when={st() === "sleeping"}>
              <text x="392" y="120" font-size="64" font-weight="bold" fill="#e8933c" class="mx-zzz">
                z
              </text>
              <text x="418" y="80" font-size="44" font-weight="bold" fill="#e8933c" class="mx-zzz mx-zzz-late">
                z
              </text>
            </Show>
          </Show>
