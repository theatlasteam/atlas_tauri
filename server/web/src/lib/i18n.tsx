...
const dict = {
  en: {
    ...
    "stats.platforms": "Windows · Linux · macOS · Android",
    ...
    "faq.a3": "Windows, Linux (.deb and AppImage), macOS and Android. iOS is on the roadmap.",
  ...
  ru: {
    ...
    "faq.a3": "Windows, Linux (.deb и AppImage), macOS и Android. iOS — в планах.",
