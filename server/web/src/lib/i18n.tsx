...
const dict = {
  en: {
    ...
    "blog.minds.demo.sleeping": "Sleeping",    "blog.minds.s1.title": "Jobs, not chats",
    ...
    "blog.minds.how": "How it works",
    "blog.mascot.say1": "Checking the listing…",
    "blog.mascot.say2": "Found it — nothing changed since 09:00.",
    "blog.mascot.say3": "I never sleep. You should.",
    "blog.mascot.say4": "Zzz… just kidding. Still watching.",
    "blog.demo.kicker": "Watch it work",
    "blog.demo.name": "Mind",
    "blog.demo.user": "Is the new Atlas build out?",
    "blog.demo.status": "Checking releases…",
    "blog.demo.tool": "Browser",
    "blog.demo.toolDetail": "github.com/theatlasteam/atlas_tauri/releases",
    "blog.demo.done": "Completed",
    "blog.demo.answer": "0.1.0-beta.1 is the latest — out this week. Want me to keep watching it?",
  },
  ru: {
    ...
    "blog.minds.how": "Как это работает",
    "blog.mascot.say1": "Проверяю объявление…",
    "blog.mascot.say2": "Нашёл — с 09:00 без изменений.",
    "blog.mascot.say3": "Я не сплю никогда. А вам бы надо.",
    "blog.mascot.say4": "Хрр… шучу. Продолжаю следить.",
    "blog.demo.kicker": "Смотрите, как работает",
    "blog.demo.name": "Разум",
    "blog.demo.user": "Вышла новая сборка Atlas?",
    "blog.demo.status": "Проверяю релизы…",
    "blog.demo.tool": "Браузер",
    "blog.demo.toolDetail": "github.com/theatlasteam/atlas_tauri/releases",
    "blog.demo.done": "Готово",
    "blog.demo.answer": "0.1.0-beta.1 — последняя, вышла на этой неделе. Продолжать следить?",
  },
} as const;
