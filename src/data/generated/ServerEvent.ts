 ...
 */
export type ServerEvent = { "type": "ready", user_id: string, } | { "type": "message", message: MessageDto, } | { "type": "message_ack", client_tag?: string, message: MessageDto, } | { "type": "message_updated", message: MessageDto, } | { "type": "read", chat_id: string, user_id: string, message_id: string, } | { "type": "typing", chat_id: string, user_id: string, 
/**
