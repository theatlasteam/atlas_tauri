/* @ts-self-types="./atlas_e2ee.d.ts" */

/**
 * @returns {string}
 */
export function e2ee2_bundle() {
    let deferred2_0;
    let deferred2_1;
    try {
        const ret = wasm.e2ee2_bundle();
        var ptr1 = ret[0];
        var len1 = ret[1];
        if (ret[3]) {
            ptr1 = 0; len1 = 0;
 ...
 * @returns {string}
 */
export function e2ee2_decrypt(peer, body) {
    let deferred4_0;
    let deferred4_1;
    try {
        ...
        const ret = wasm.e2ee2_decrypt(ptr0, len0, ptr1, len1);
        var ptr3 = ret[0];
        var len3 = ret[1];
        if (ret[3]) {
            ptr3 = 0; len3 = 0;
 ...
 * @returns {string}
 */
export function e2ee2_encrypt(peer, plaintext) {
    let deferred4_0;
    let deferred4_1;
    try {
        const ptr0 = passStringToWasm0(peer, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        ...
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.e2ee2_encrypt(ptr0, len0, ptr1, len1);
        var ptr3 = ret[0];
        var len3 = ret[1];
        if (ret[3]) {
            ptr3 = 0; len3 = 0;
 ...
 * @returns {string}
 */
export function e2ee2_fingerprint(bundle_json) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(bundle_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.e2ee2_fingerprint(ptr0, len0);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
...
export function e2ee2_has_session(peer) {
    const ptr0 = passStringToWasm0(peer, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.e2ee2_has_session(ptr0, len0);
    if (ret[2]) {
 ...
 * @returns {string}
 */
export function e2ee2_new_prekeys(count) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ret = wasm.e2ee2_new_prekeys(count);
        var ptr1 = ret[0];
        var len1 = ret[1];
        if (ret[3]) {
            ptr1 = 0; len1 = 0;
 ...
 * @param {string} peer
 * @param {string} bundle_json
 * @param {string | null} [one_time_prekey]
 */
export function e2ee2_start_session(peer, bundle_json, one_time_prekey) {
    const ptr0 = passStringToWasm0(peer, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(bundle_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    var ptr2 = isLikeNone(one_time_prekey) ? 0 : passStringToWasm0(one_time_prekey, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len2 = WASM_VECTOR_LEN;
    const ret = wasm.e2ee2_start_session(ptr0, len0, ptr1, len1, ptr2, len2);
    if (ret[1]) {
 ...
 * @returns {string}
 */
export function e2ee_open(peer_public_key, body) {
    let deferred4_0;
    let deferred4_1;
    try {
        const ptr0 = passStringToWasm0(peer_public_key, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(body, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.e2ee_open(ptr0, len0, ptr1, len1);
        var ptr3 = ret[0];
        var len3 = ret[1];
        if (ret[3]) {
            ptr3 = 0; len3 = 0;
 ...
 * @returns {string}
 */
export function e2ee_public_key() {
    let deferred2_0;
    let deferred2_1;
    try {
        const ret = wasm.e2ee_public_key();
        var ptr1 = ret[0];
        var len1 = ret[1];
        if (ret[3]) {
            ptr1 = 0; len1 = 0;
 ...
 * @returns {string}
 */
export function e2ee_seal(peer_public_key, plaintext) {
    let deferred4_0;
    let deferred4_1;
    try {
        const ptr0 = passStringToWasm0(peer_public_key, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        ...
        const ptr1 = passStringToWasm0(plaintext, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.e2ee_seal(ptr0, len0, ptr1, len1);
        var ptr3 = ret[0];
        var len3 = ret[1];
        if (ret[3]) {
            ptr3 = 0; len3 = 0;
 ...
 * @returns {string}
 */
export function store_dump() {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.store_dump();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
 ...
 * @param {string} json
 */
export function store_hydrate(json) {
    const ptr0 = passStringToWasm0(json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    wasm.store_hydrate(ptr0, len0);
}
...
function decodeText(ptr, len) {
    ...
    if (numBytesDecoded >= MAX_SAFARI_DECODE_BYTES) {
        cachedTextDecoder = new TextDecoder('utf-8', { ignoreBOM: true, fatal: false });
        cachedTextDecoder.decode();
        numBytesDecoded = len;
    }
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('atlas_e2ee_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
